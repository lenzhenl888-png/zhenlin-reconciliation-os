    ...
    <ClickSpark duration={420} sparkColor="#1f7a8c" sparkCount={8} sparkRadius={18} sparkSize={11}>
      ...
      {modal?.type === "receiptPool" && (
        <ReceiptPoolModal
          ...
          store={store}
          targetStatementId={selectedStatement?.id}
          onClose={() => setModal(null)}
    ...
    <section className="recon-detail">
      ...
      {props.detailTab === "payment" && (
        <PaymentAllocationCards
          ...
          receipts={props.receipts}
          styleNoOf={(styleAccountId) =>
            props.statementItems.find((item) => item.item.styleAccountId === styleAccountId)?.styleAccount?.styleNo ?? "-"
          }
        />
      )}
      {props.itemSummary && (
...
function PaymentAllocationCards(props: {
  ...
  receipts: CustomerReceipt[];
  styleNoOf(styleAccountId: string): string;
}) {
  return (
        ...
        return (
          <article className="recon-allocation-card" key={allocation.id}>
            ...
            <dl>
              ...
              <div>
                <dt>关联款号</dt>
                <dd>{allocation.styleAccountId ? props.styleNoOf(allocation.styleAccountId) : "整月"}</dd>
              </div>
              <div>
                <dt>收款方式</dt>
      ...
      {allocationReceiptId && props.customer && (() => {
        ...
        return (
          <SettlementModal
            ...
            receipt={receipt}
            store={props.store}
            targetStatementId={props.targetStatementId}
